...
if project.REMOTE:
    SUITE = project.SUITE_OPTIMAL_STRIPS_WITHOUT_STORAGE # remove task where objects with either are present.
    ...
    SUITE = ["sokoban-opt08-strips:p01.pddl"] # project.SUITE_OPTIMAL_STRIPS
